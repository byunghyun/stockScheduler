...
import Example from '../components/chart/ChartTest'
import WarehousingFlow from '../components/warehousingFlow';
import DenseTable from '../components/table/MainPageFooterTable';
        ...
        <div className='w-full h-full'>
            <ul className='flex'>
                <li className='flex flex-col justify-between flex-1 h-[130px] text-[13px] bg-white mr-4 p-4 shadow-md rounded-lg'>
                    <p>입고</p>
                    <div>
                        <p className='text-[30px] font-semibold'>1,120</p>
                ...
                <li className='flex flex-col justify-between flex-1 h-[130px] text-[13px] bg-white mr-4 p-4 shadow-md rounded-lg'>
                    <p>출고</p>
                    <div>
                        <p className='text-[30px] font-semibold'>1,000</p>
            ...
            <div className='relative flex flex-row text-[13px] mt-4'>
                ...
                <div className='absolute ml-2 right-0 w-[calc(50%-8px)] h-full bg-white p-4 shadow-md rounded-lg overflow-hidden'>
                    ...
                    <div className='h-[calc(100%-35.5px)] overflow-auto'>
                        <WarehousingFlow />
                    </div>
                </div>
            </div>
